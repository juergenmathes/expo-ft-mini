...
# 1) D3IL fork (editable path dep of pyproject.toml). Bound workspace; not baked into the image.
...
# 2) workspace .venv (owned by vscode after UID remap; uv cache is a named volume)
